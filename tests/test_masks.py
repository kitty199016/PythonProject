...
def test_get_mask_card_number_positive(number_card_input:int, result:str):
    assert get_mask_card_number(number_card_input) == result


@pytest.mark.parametrize("number_card_input", cases_negative)
def test_get_mask_card_number_negative(number_card_input:int):
...
def test_get_mask_account_positive(account_number_input:int, result:str):
    assert get_mask_account(account_number_input) == result


@pytest.mark.parametrize("account_number_input", cases_account_negative)
def test_gget_mask_account_negative(account_number_input:int):
    with pytest.raises(ValueError):
